      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div>
            ...
            <ul className="space-y-4">
              <li className="flex items-center">
                ...
                <a href="mailto:hello@geracaodeconteudo.com.br" className="text-neutral-400 hover:text-white transition-colors">hello@geracaodeconteudo.com.br</a>
              </li>
              <li className="flex items-center">
                <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 mr-2 text-neutral-400" fill="none" viewBox="0 0 24 24" stroke="currentColor">
        ...
        <div className="mt-12 pt-8 border-t border-neutral-800 flex flex-col md:flex-row justify-between items-center">
          ...
          <div className="flex space-x-6 mt-4 md:mt-0">
            <a href="https://www.linkedin.com/in/marcelambiente/" 
               className="text-neutral-400 hover:text-white transition-colors"
               aria-label="LinkedIn da Geração de Conteúdo"
               target="_blank"
               rel="noopener noreferrer">
            ...
            <a href="https://twitter.com/gdeconteudo" 
               className="text-neutral-400 hover:text-white transition-colors"
               aria-label="Twitter da Geração de Conteúdo"
               target="_blank"
               rel="noopener noreferrer">
            ...
            <a href="https://www.instagram.com/geracaodeconteudo/" 
               className="text-neutral-400 hover:text-white transition-colors"
               aria-label="Instagram da Geração de Conteúdo"
               target="_blank"
               rel="noopener noreferrer">
